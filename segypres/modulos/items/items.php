...
function formEdItems($id, $errores = false) {
	...
	$link_ret = "<a href=\"?r=".ITEMS_LISTAR ."\"><input type=\"button\" value=\"Cancelar\" class=\"btn-primary\" ></a>    ";
	...
	$html = <<<MOSTREG
		<div id="div_mostrar_datos">\n
			...
			<table>
                            <tr>
			        <td><label for="numitem">Modulo :</label></td>			    
			    </tr>          
                            <tr>
                                <td><select name="modulo" class="form-control">
                                    <option>Trabajos preliminares</option>
                                    <option>Movimiento de tierras</option>
                                    <option>Obra gruesa</option>
                                    <option>Obra fina</option>
                                    <option>Instalaciones hidrosanitarias</option>
                                    <option>Instalaciones electricas</option>
                                    <option>Trabajos de acabado</option>
                                    <option>Jardines y Exteriores</option>
                                    <option>Vias y accesos</option>                                    
                                    </select></td>
                            </tr>
                            <tr>
			        <td><label for="numitem">Num. Item</label></td>			    
			    </tr>    
                            <tr>
                                <td><input type="text" name="numitem" value="{$reg['numitem']}" 
			        	maxlength="200" size="60" class="form-control" placeholder="Ingrese numero de item" /></td>
                            </tr>    
                            <tr>
			        <td><label for="descripcion">Descripci&oacute;n:</label></td>			        
			        	...
			        	maxlength="200" size="80" class="form-control" placeholder="Ingrese descripción" /></td>
                            </tr>
                            <tr><td><label class="etiqueta" for="unidad">Unidad:</label></td></tr>   
                            <tr><td><select name="unidad" class="form-control">
                                    <option value="m" {$op1}>metro</option>
                                    <option value="m2" {$op2}>metro 2</option>
                                    <option value="m3" {$op3}>metro 3</option>
                                    <option value="glb" {$op4}>glb</option>
                            ...
                            <tr><td><label for="precio_unit">Precio unitario:</label></td></tr>    
                            <tr><td><input type="text" name="precio_unit" value="$precio_unit" 
			        	maxlength="10" size="8" class="form-control"/></td></tr>    
                            
                            <tr><td><div class="div-sep"></div></td></tr>
                            <tr><td>
			    	<input type="submit" value="Guardar" class="btn-primary">	 $link_ret
			    	</td>
                             </tr> 
			</table>
                         </div>
